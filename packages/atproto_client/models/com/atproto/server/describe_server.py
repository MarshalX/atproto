...
class Response(base.ResponseModelBase):
    ...
    contact: t.Optional['models.ComAtprotoServerDescribeServer.Contact']  #: Contact information.
    invite_code_required: t.Optional[bool] = (
        None  #: If true, an invite code must be supplied to create an account on this instance.
    )
    links: t.Optional['models.ComAtprotoServerDescribeServer.Links']  #: URLs of service policy documents.
