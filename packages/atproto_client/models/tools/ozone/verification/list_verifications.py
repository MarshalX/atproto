...
class Params(base.ParamsModelBase):
    ...
    sort_direction: t.Optional[t.Literal['asc', 'desc']] = 'desc'  #: Sort direction for creation date.
...
class ParamsDict(t.TypedDict):
    ...
    sort_direction: te.NotRequired[t.Optional[t.Literal['asc', 'desc']]]  #: Sort direction for creation date.
