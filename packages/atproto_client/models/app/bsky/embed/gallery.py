...
class Main(base.ModelBase):
    ...
    items: t.List[unknown_union.OpenUnion['models.AppBskyEmbedGallery.Image']] = Field(
        max_length=20
...
class View(base.ModelBase):
    ...
    items: t.List[unknown_union.OpenUnion['models.AppBskyEmbedGallery.ViewImage']]  #: Items.
