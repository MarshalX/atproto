...
class Client(SessionMethodsMixin, ClientRaw):
    ...
    def get_all_follows(self, profile_identify: t.Optional[str] = None) -> models.AppBskyGraphGetFollows.Response:
        """Get All Follows
        ...
        def _fetch(actor: str, cursor: t.Optional[str]) -> models.AppBskyGraphGetFollows.Response:
            d = models.AppBskyGraphGetFollows.Params(actor=actor, limit=100)
            if cursor:
                d.cursor = cursor
            return self.bsky.graph.get_follows(d)
    ...
    def get_all_followers(self, profile_identify: t.Optional[str] = None) -> models.AppBskyGraphGetFollowers.Response:
        """Get All Followers
        ...
        def _fetch(actor: str, cursor: t.Optional[str]) -> models.AppBskyGraphGetFollowers.Response:
            d = models.AppBskyGraphGetFollowers.Params(actor=actor, limit=100)
            if cursor:
                d.cursor = cursor
            return self.bsky.graph.get_followers(d)
